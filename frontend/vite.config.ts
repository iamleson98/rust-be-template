...
export default defineConfig({
  ...
  build: {
    ...
    // (The basemap is a raster CARTO TileLayer since the OpenFreeMap/
    // MapLibre-GL bridge removal — no ~950KB vector renderer chunk anymore,
    // only Leaflet's ~155KB, lazy-loaded by map views.)
