...
import { lookupSchema, type LookupValues } from './guest-lookup-form'

// Re-export shared types for backward compatibility (other modules may
// still `import { BookingItem } from '@/components/bus/my-bookings'`).
export type { BookingItem, ReviewItem, ReviewSummary } from './booking-types'
...
const FeedbackForm = lazy(() => import('./feedback-form').then((m) => ({ default: m.FeedbackForm })))
