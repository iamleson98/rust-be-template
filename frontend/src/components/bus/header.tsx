...
const NotificationBell = lazy(() => import('./notification-bell').then((m) => ({ default: m.NotificationBell })))
const WishlistButton = lazy(() => import('./wishlist-button').then((m) => ({ default: m.WishlistButton })))
const LoyaltyWidget = lazy(() => import('./loyalty-widget').then((m) => ({ default: m.LoyaltyWidget })))
