...
export const processMemory = <ThrowOnError extends boolean = false>(options?: Options<ProcessMemoryData, ThrowOnError>): RequestResult<ProcessMemoryResponses, ProcessMemoryErrors, ThrowOnError> => (options?.client ?? client).get<ProcessMemoryResponses, ProcessMemoryErrors, ThrowOnError>({ url: '/api/admin/system/memory', ...options });
