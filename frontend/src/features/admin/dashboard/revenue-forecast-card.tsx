          ...
          <Card className="overflow-hidden h-full">
            ...
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between gap-3">
                <CardTitle className="text-base flex items-center gap-2">
                  ...
                  {t('adminDash.revenueForecastTitle')}
                </CardTitle>
            ...
            <CardContent className="pt-0">
              ...
              <div className="flex items-center justify-between mt-3 pt-3 border-t text-xs">
                <div>
                  <div className="text-muted-foreground">{t('adminDash.nextWeekForecast')}</div>
                  <div className="text-base font-bold text-blue-700 mt-0.5">
                    {formatVNDShort(forecast.forecast.reduce((a, b) => a + b * 1_000_000, 0))}
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-muted-foreground">{t('adminDash.trend')}</div>
                  <div
