              ...
              <div className="rounded-lg border bg-slate-50/60 p-4 space-y-3">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 text-sm font-semibold">
                    ...
                    {t('adminSchedules.routeSectionTitle')}
                  </div>
                  {startName && endName ? (
                      ...
                      <FormItem className="grid gap-1.5">
                        <FormLabel>
                          <span className="flex items-center gap-1.5">
                            ...
                            {t('adminSchedules.startPoint')} <span className="text-destructive">*</span>
                          </span>
                        </FormLabel>
                        <FormControl>
                          <AddressPointSelect
                  ...
                  render={({ field }) => (
                    <FormItem className="grid gap-2">
                      <FormLabel className="flex items-center gap-1.5">
                        ...
                        {t('adminSchedules.middlePointLabel')}
                      </FormLabel>
                      <div className="space-y-2">
                        {field.value.map((mid, i: number) => (
                          <div key={i} className="grid grid-cols-[auto_1fr_auto_auto] gap-1.5 items-center">
                            ...
                            <div className="flex flex-col gap-0.5">
                              <button
                                type="button"
                                aria-label={t('adminSchedules.moveUp')}
                                disabled={i === 0}
                              ...
                              <button
                                type="button"
                                aria-label={t('adminSchedules.moveDown')}
                            ...
                            <button
                              type="button"
                              aria-label={t('adminSchedules.removeMiddlePoint')}
                        ...
                        >
                          ...
                          {t('adminSchedules.addMiddlePoint')}
                        </button>
                      </div>
                      <FormMessage />
                    </FormItem>
                      ...
                      <FormItem className="grid gap-1.5">
                        <FormLabel>
                          <span className="flex items-center gap-1.5">
                            ...
                            {t('adminSchedules.endPoint')} <span className="text-destructive">*</span>
                          </span>
                        </FormLabel>
                        <FormControl>
                          <AddressPointSelect
