        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text_null(Booking::BoardingPointId))
                    .col(text_null(Booking::DroppingPointId))
                    ...
                    .col(text_null(Booking::CampaignAppliedId))
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text(BookingSeat::BookingId))
                    .col(text(BookingSeat::SeatId))
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text(SeatInventory::TripSessionId))
                    .col(text(SeatInventory::SeatId))
                    ...
                    .col(text_null(SeatInventory::HeldByBookingId))
