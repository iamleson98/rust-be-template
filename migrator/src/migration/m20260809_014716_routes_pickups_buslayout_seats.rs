        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text_null(Route::BrandId))
                    .col(string_len(Route::Name, 255))
                    .col(text_null(Route::StartLocationId))
                    .col(text_null(Route::EndLocationId))
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text_null(BusLayout::BrandId))
