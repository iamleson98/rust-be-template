...
pub mod consts {
    ...
    pub const ADMIN_CRON_JOBS_READ: &str = "admin:cron-jobs:read";
    pub const ADMIN_CRON_JOBS_WRITE: &str = "admin:cron-jobs:write";
    ...
    pub const ADMIN_BUS_LAYOUTS_WRITE: &str = "admin:bus_layouts:write";
