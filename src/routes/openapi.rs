...
#[openapi(
    paths(
        ...
        // admin — route pictures (gallery: upload / reorder / delete)
        crate::routes::admin::route_pictures::list_pictures,
        crate::routes::admin::route_pictures::upload_picture,
        crate::routes::admin::route_pictures::patch_picture,
        crate::routes::admin::route_pictures::delete_picture,
        crate::routes::admin::route_pictures::delete_all_pictures,
        // media proxy (immutable, ETag-cacheable image bytes)
        crate::routes::media::serve,
        // admin — schedules
    ...
    components(schemas(
        ...
        crate::dto::route_media::RoutePictureOut,
        crate::dto::route_media::RoutePictureListResponse,
        crate::dto::route_media::RoutePictureUploadResponse,
        crate::dto::route_media::RoutePictureDeleteResponse,
        crate::dto::route_media::RoutePicturesBulkDeleteResponse,
        crate::dto::route_media::UpdateRoutePictureInput,
