...
use crate::dto::routing::{DirectionsQueryDto, DirectionsResponse, IsochroneQueryDto, IsochroneResponse, MatrixQueryDto, MatrixResponse};
...
pub async fn directions(State(st): State<AppState>, Query(q): Query<DirectionsQueryDto>) -> Result<Json<DirectionsResponse>, AppError> {
...
pub async fn matrix(State(st): State<AppState>, Query(q): Query<MatrixQueryDto>) -> Result<Json<MatrixResponse>, AppError> {
...
pub async fn isochrone(State(st): State<AppState>, Query(q): Query<IsochroneQueryDto>) -> Result<Json<IsochroneResponse>, AppError> {
