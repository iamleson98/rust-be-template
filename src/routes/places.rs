...
use crate::dto::place::{
    PlaceListResponse, PlaceReverseResponse, PlaceSearchResponse,
};
...
pub async fn list(State(st): State<AppState>, Query(q): Query<ListQuery>) -> Result<Json<PlaceListResponse>, AppError> {
...
pub async fn search(State(st): State<AppState>, Query(q): Query<SearchQuery>) -> Result<Json<PlaceSearchResponse>, AppError> {
...
pub async fn reverse(State(st): State<AppState>, Query(q): Query<ReverseQuery>) -> Result<Json<PlaceReverseResponse>, AppError> {
