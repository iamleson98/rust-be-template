        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text(ChatChannel::UserId))
                    .col(text_null(ChatChannel::BrandId))
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text(ChatMessage::ChannelId))
                    .col(string_len(ChatMessage::SenderType, 20))
                    .col(text_null(ChatMessage::SenderId))
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(text(ChatAssignment::ChannelId))
